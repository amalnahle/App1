...
###can use cashinf to upload data faster if data was bigger
...
By_Sport = By_Sport[By_Sport.Year != 'Unnamed: 13']

#sports dataframe used to get the forecasts results 
By_Sport2 = pd.melt(by_sport2, id_vars=['Sport'], var_name='Year', value_name='Nb of Injuries').sort_values('Sport')
By_Sport2= By_Sport[By_Sport2.Year != 'Unnamed: 13']
...
Cost = Cost[Cost.Year != 'Unnamed: 13']
...
By_Gender = By_Gender[By_Gender.Year != 'Unnamed: 13']
...
By_Diagnosis=By_Diagnosis[By_Diagnosis.Year != 'Unnamed: 13']
...
By_Age=By_Age[By_Age.Year != 'Unnamed: 13']
...
By_Ethnicity=By_Ethnicity[By_Ethnicity.Year != 'Unnamed: 13']
...
### DEVELOP FORECAST MODEL TO USE IT LATER###
...
if selectbox == 'Dashboard':
    ...
    with g2:
        ...
        ###FORECASTS (excluding year 2020 - outlier due to covid-19)
    ...
    with g3:
        ...
        #st.write(fig4)
        st.markdown(f"<div style='text-align: center; color: #000505; font-size: 20px;font-family:Montserrat; background-color: #D9DAD9;'> Number of injuries across regions </div>", unsafe_allow_html=True)
